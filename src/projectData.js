export const data = [
	...
	},
	{
		...
		description:
			"Python App made with Django. Allows users to view list of all recipes, click any recipe to view it's details, create new recipes, and search the catalog of recipes by difficulty level. Search results return data in charts which can be chosen by the user.",
		shortDescription: "Python App made with Django. Allows users to view recipes.",
		type: "Bootcamp Project",
		special: "",
		images: [
			{ source: "./img/project/recipeapp_3.png", alt: "screenshot of recipe search" },
			{ source: "./img/project/recipeapp_1.png", alt: "screenshot of login screen" },
			{ source: "./img/project/recipeapp_2.png", alt: "screenshot of recipe list" },
			{ source: "./img/project/recipeapp_4.png", alt: "screenshot of create recipe screen" },
			{ source: "./img/project/recipeapp_5.png", alt: "screenshot of logout screen" },
		],
	},
	{
		name: "THIS Website",
